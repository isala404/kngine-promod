...
main()
{
	...
	//Supiri
	LoadPlugin( plugins\supiri\_cmd::init, "Powerup B3", "Supiri" );
	LoadPlugin( plugins\supiri\_thread::init, "Spawn Threads", "Supiri" );

	
	//Crazy
	LoadPlugin( plugins\crazy\_clock::init, "Display Time", "Crazy" );
	/**/
	/* ==== END ==== */
}
